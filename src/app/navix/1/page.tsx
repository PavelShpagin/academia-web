...
export default function NaviX1Page() {
  return (
      ...
      <section className="pt-[72px]">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-24 pt-20 md:pt-28 pb-28 md:pb-40">
          ...
          <p className="text-lg text-neutral-400 max-w-2xl leading-relaxed mb-8">
            Visual navigation without GPS for UAVs. Matches drone camera images to pre-processed satellite map tiles using a DeiT Vision Transformer, then fuses visual matches with visual-inertial odometry across the full trajectory. No retraining required for new terrain.
          </p>
      ...
      <section className="border-t border-white/10">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-24 py-28 md:py-40">
          ...
          <div className="max-w-3xl">
            <h3 className="text-[13px] font-medium tracking-wide uppercase text-neutral-500 mb-6">Navigation &amp; Performance</h3>
