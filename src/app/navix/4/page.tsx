...
export default function NaviX4Page() {
  return (
      ...
      <section className="pt-[72px]">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-24 pt-20 md:pt-28 pb-20 md:pb-28">
          ...
          <p className="text-lg text-neutral-400 max-w-2xl leading-relaxed mb-8">
            Visual navigation without GPS for UAVs.
          </p>
      ...
      <section className="border-t border-white/10">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-24 py-28 md:py-40">
          <div className="max-w-3xl">
            <p className="text-[17px] text-neutral-300 leading-relaxed">
              NaviX determines UAV position by matching onboard camera images to pre-processed satellite map tiles. It uses a DeiT Vision Transformer to extract visual fingerprints from each frame, then fuses these matches with visual-inertial odometry across the full flight trajectory. The system achieves 20–30m average accuracy at 9 FPS on a Raspberry Pi 5, works day and night, and requires no retraining for new terrain — map preparation takes less than 5 minutes per 10 km².
            </p>
          </div>
        </div>
      </section>
